...
-- analyze blood pressure in each age group
select 
case 
    ...
    when diastolic_bp >= 90 or systolic_bp >= 140 then "Stage 2 Hypertension"
    when systolic_bp > 180 or diastolic_bp > 120 then "Hypertension Crisis"
    else "Uncategorized"
...
round(avg(bmi), 2) as avg_bmi 
from patients
group by blood_pressure_check, age_group
order by patient_count desc;
# Stage 2 Hypertension is most common in patients who are 80 and above with 28,043 patients having high blood pressure
